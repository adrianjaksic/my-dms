...
(function (window, document, undefined) {
    ...
    window.Feedback = function (options) {
        ...
        returnMethods = {
            ...
            open: function () {
                ...
                //pomeranje prozora
                //modal.setAttribute("id", "draggable");
    ...
    window.Feedback.Form = function (elements) {
        ...
        this.elements = elements || [{
            ...
            label: "Molimo Vas da ukratko opišite problem na koji ste naišli",
            required: false
        }];
    ...
    window.Feedback.Screenshot.prototype.start = function (modal, modalHeader, modalFooter, nextButton) {
        ...
        if (this.h2cDone) {
            ...
            blackoutButton = element("a", "Zacrni"),
            highlightButton = element("a", "Istakni"),
            previousElement;
            ...
            this.dom.appendChild(element("p", "Ako želite, možete da istaknete ili zacrnite informacije na ekranu."));
