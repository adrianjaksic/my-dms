...
onManualRetry:function(){},onValidate:function(){}},messages:{typeError:"Fajl {file} nije odgovarajućeg tipa!\nIspravni tipovi: {extensions}.",sizeError:"Fajl {file} je veći od dozvoljenje veličine ({sizeLimit}).",minSizeError:"{file} is too small, minimum file size is {minSizeLimit}.",emptyError:"{file} is empty, please select files again without it.",noFilesError:"No files to upload.",onLeave:"The files are being uploaded, if you leave now the upload will be cancelled."},retry:{enableAuto:!1,maxAutoAttempts:3,
